      ...
      <div className="modal-dialog modal-dialog-centered mh-50" style={{ maxWidth: 510, height: 0 }}>
        <div className="modal-content popup-shadow" style={{ minHeight: 530, maxHeight: 530 }}>
          ...
          <div id="modal-body" className="modal-body m-3">
            ...
            <hr></hr>
            <input type="text" className="flatpickr-form-control form-control" autoComplete="off" placeholder={transLangKey("INSERT_SCHEDULE")} disabled={editable} value={content} onKeyDown={handleKeyPress} onChange={handleChange}></input>
