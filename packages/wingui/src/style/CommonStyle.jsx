...
export const useInputStyles = (props) => {
  const { useInputStyles } = useContext(AppStyleContext)
  return useInputStyles(props)
}

export const useFormInputStyles = (props) => {
  const { useFormInputStyles } = useContext(AppStyleContext)
  return useFormInputStyles(props)
}

export const useSearchMenuStyles = (props) => {
  const { useSearchMenuStyles } = useContext(AppStyleContext)
  return useSearchMenuStyles(props)
}
export const useIconStyles = (props) => {
  const { useIconStyles } = useContext(AppStyleContext)
  return useIconStyles(props)
}
export const useSidebarStyles = (props) => {
  const { useSidebarStyles } = useContext(AppStyleContext)
...
export const useFloatMenuStyles = (props) => {
  const { useFloatMenuStyles } = useContext(AppStyleContext)
  return useFloatMenuStyles(props)
}
export const useLargeMenuDropdownStyles = (props) => {
  const { useLargeMenuDropdownStyles } = useContext(AppStyleContext)
...
export const useWidgetStyle = (props) => {
