...
public class DelegationController {
    ...
    @GetMapping("/system/users/{delegation-username}/delegations")
    public List<Delegation> getDelegations(@PathVariable("delegation-username") String delegationUsername) {
        return delegationService.getDelegationsByDelegatedUser(delegationUsername);
    }
