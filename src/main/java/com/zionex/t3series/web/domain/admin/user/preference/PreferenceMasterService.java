...
public class PreferenceMasterService {
    ...
    public List<PreferenceMaster> getPreferenceMasters(String viewCd, String viewNm) {
        List<PreferenceMaster> preferenceMasters = preferenceMasterRepository.findByViewCdContainingIgnoreCaseOrderByViewCdAscGridCdAsc(viewCd);

        if (preferenceMasters == null) {
