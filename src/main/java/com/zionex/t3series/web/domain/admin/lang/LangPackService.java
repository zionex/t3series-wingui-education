...
public class LangPackService {
        ...
        if (langCd.equals("all")) {
            ...
            if (languages != null) {
                for (String language : languages) {
                    cachedData.remove(language);
                    resultLangPack.putAll(getCachedLangPacks(language));
                }
            }
        } else {
    ...
    public Map<String, Map<String, String>> getLangPacks(String langCd) {
        ...
        langPackData.put(langCd, langPacks
                .stream()
                .collect(HashMap::new, (m, v) -> m.put(v.getLangKey(), v.getLangValue()), HashMap::putAll));
