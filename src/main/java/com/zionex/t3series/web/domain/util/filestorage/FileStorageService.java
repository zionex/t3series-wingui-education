...
public class FileStorageService {
    ...
    public String getAbsoluteFilePath(int id) throws IOException {
    ...
    public ResponseEntity<Resource> downloadFileUseFilePath(String query, FileStorage fileStorage, HttpServletRequest request) throws IOException {
